...
const grafem = ["\u00A4", "\u0024", "\u20AC", "\u0024", "\u00A3", "\u20BD", "\u0024", "\u5143", "\u20A8", "\u0024", "\u20BD"];
const time = {};
// const JSvalue = { inputImg: 'inputImg', outputImg, grafInput, grafOut, input, inputRate, outputRate, result, resultOld, inputValue, inputCurrency, outputCurrency};

// const JSvalue = ["inputImg", "outputImg", "grafInput", "grafOut", "input", "inputRate", "outputRate", "result", "resultOld", "inputValue", "inputCurrency","outputCurrency"];
// const JSID = ["inputImg", "outputImg", "grafInput", "grafOut", "input", "input_rate", "output-rate", "result", "result-old", "inputValue", "inputCurrency", "outputCurrency"];

// for (let x in JSvalue) {
//   const JSvalue[x] = document.querySelector(`#${JSvalue[x].value}`);
// }
